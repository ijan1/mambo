...
size_t scan_a64(dbm_thread *thread_data, uint32_t *read_address,
  ...
  while(!stop) {
    ...
    switch (inst){
      ...
      case A64_SVE2_PERMUTE_QUAD:
      case A64_SVE_TBL_3SRCS:
      case A64_SVE_TBL:
      case A64_SVE_PERMUTE_VEC_UNPRED:
      case A64_SVE_PERMUTE_PRED:
      case A64_SVE_PERMUTE_VEC:
      case A64_SVE_PERMUTE_VEC_PRED:
      case A64_SVE_SEL:
      case A64_SVE_PERMUTE_EXTRACT:
      case A64_SVE_PERMUTE_SEGMENT:
      ...
      case A64_SVE_UNARY_PRED:
      case A64_SVE_FREC_RED:
      case A64_SVE_UNARY_UNPRED:
      case A64_SVE_FCM_ZERO:
      case A64_SVE_FADDA:
