...
size_t scan_a64(dbm_thread *thread_data, uint32_t *read_address,
  ...
  while(!stop) {
    ...
    switch (inst){
      ...
      case A64_LRCPC:
      case A64_LRCPC2:
      case A64_SVE_MOVPRFX:
      case A64_SVE_MOVPRFX_PRED:
      case A64_SVE_ADD_SUB_VEC_PRED:
      case A64_SVE_ADDPL_ADDVL:
      case A64_SVE_ADR:
      case A64_SVE_ADD_TO_S:
      case A64_SVE_ADD_Q_TO_S:
      case A64_SVE_MIN_MAX_TO_S:
      case A64_SVE_MIN_MAX_Q_TO_S:
      case A64_SVE_MAX_VEC:
      case A64_SVE_SHIFT_IMM_PRED:
      case A64_SVE_SHIFT_VEC_PRED:
      case A64_SVE_EXTEND_PRED:
      case A64_SVE_MUL_VEC_PRED:
      case A64_SVE_DIV_VEC_PRED:
      case A64_SVE_ABS_NEG:
      case A64_SVE_LOG_TO_SCALAR:
      case A64_SVE_LOG_Q_TO_SCALAR:
      case A64_SVE_SHIFT_WIDE_PRED:
      case A64_SVE_LOG_VEC_PRED:
      case A64_SVE_CNT_VEC:
      case A64_SVE_MUL_ACC_ADDEND:
      case A64_SVE_MUL_ACC_MULT:
      case A64_SVE_SAT_INCX_DECX_VEC:
      case A64_SVE_CNTX:
      case A64_SVE_INCX_DECX_VEC:
      case A64_SVE_INCX_DECX_SCALAR:
      case A64_SVE_SAT_INCX_DECX_SCAL:
      case A64_SVE_XAR:
      case A64_SVE_SHIFT_R_IMM_UNPRED:
      case A64_SVE_SHIFT_L_IMM_UNPRED:
      case A64_SVE_SAT_ADD_VEC_UNPRED:
      case A64_SVE_SAT_SUB_VEC_UNPRED:
      case A64_SVE_ADD_SUB_VEC_UNPRED:
      case A64_SVE_LOG_VEC_UNPRED:
      case A64_SVE_BITWISE_UNPRED:
      case A64_SVE_INDEX_IMM:
      case A64_SVE_INDEX_SCA_IMM:
      case A64_SVE_INDEX_IMM_SCA:
      case A64_SVE_INDEX_SCALARS:
      case A64_SVE_MULH_UNPRED:
      case A64_SVE_MUL_PMUL:
      case A64_SVE_SQMULH_SQRDMULH:
      case A64_SVE_SHIFT_WIDE_UNPRED:
      case A64_SVE_FTSSEL:
      case A64_SVE_MOVPRFX_UNPRED:
      case A64_SVE_PUNPKHI_PUNPKLO:
      case A64_SVE_DUPQ:
      case A64_SVE_EXTQ:
      case A64_SVE_EXT:
      case A64_SVE_DUPM_MOV_UNPRED:
      case A64_SVE_LOG_IMM_UNPRED:
      case A64_SVE_MOV_FMOV_PRED:
      case A64_SVE_FCPY_FMOV:
      case A64_SVE_DUP_MOV_SCALAR:
      case A64_SVE_MOV_FP_PRED:
      case A64_SVE_COMPACT:
      case A64_SVE_LASTX_SCALAR:
      case A64_SVE_LASTX_FP:
      case A64_SVE_RBIT_REVX:
      case A64_SVE_CPY_MOV_SCALAR_PRED:
      case A64_SVE_CLASTX_VEC:
      case A64_SVE_CLASTX_FP:
      case A64_SVE_SPLICE:
      case A64_SVE_REVD:
      case A64_SVE_PMOV_TO_PRED:
      case A64_SVE_PMOV_TO_VEC:
      case A64_SVE_PERMUTE_PRED:
      case A64_SVE_CLASTX_SCALAR:
      case A64_SVE_SU_UNPK_HI_LO:
      case A64_SVE_INSR_FP:
      case A64_SVE_REV_PRED:
      case A64_SVE_REV_VECTOR:
      case A64_SVE_DUP_MOV_UNPRED:
      case A64_SVE_TBL:
      case A64_SVE_TBX:
      case A64_SVE_TBXQ:
      case A64_SVE_ZIP_VEC:
      case A64_SVE_UZP_VEC:
      case A64_SVE_TRN_VEC:
      case A64_SVE_MOV_VEC_PRED:
      case A64_SVE_CMP_VEC:
      case A64_SVE_BRKN:
      case A64_SVE_LOG_PREDS:
      case A64_SVE_BRKP:
      case A64_SVE_BRKA:
      case A64_SVE_PTEST:
      case A64_SVE_PFIRST:
      case A64_SVE_PFALSE:
      case A64_SVE_RDFFR_PRED:
      case A64_SVE_RDFFR_UNPRED:
      case A64_SVE_PSEL:
      case A64_SVE_CTERM:
      case A64_SVE_PNEXT:
      case A64_SVE_PTRUE_PRED:
      case A64_SVE_CMP_IMM:
      case A64_SVE_PEXT_PRED:
      case A64_SVE_PEXT_PRED_PAIR:
      case A64_SVE_PTRUE_PRED_AS_CTR:
      case A64_SVE_SU_Q_ADD_SUB_IMM:
      case A64_SVE_CNTP_PRED_AS_CTR:
      case A64_SVE_CNTP_PRED:
      case A64_SVE_ADD_SUB_IMM:
      case A64_SVE_WRFFR:
      case A64_SVE_MIN_MAX_IMM:
      case A64_SVE_Q_INCP_DECP_VEC:
      case A64_SVE_Q_INCP_DECP_SCALAR:
      case A64_SVE_SETFFR:
      case A64_SVE_INCP_DECP_VEC:
      case A64_SVE_INCP_DECP_SCALAR:
      case A64_SVE_MOV_FMOV_UNPRED:
      case A64_SVE_WHILE_PRED:
      case A64_SVE_WHILERW_WHILEWR:
      case A64_SVE_WHILE_PRED_PAIR:
      case A64_SVE_DOT_2WAY_VEC:
      case A64_SVE_MUL_ACC_INDEXED:
      case A64_SVE_MUL_INDEXED:
      case A64_SVE_SQDMULL_INDEXED:
      case A64_SVE_SQDMLSLBT:
      case A64_SVE_SHIFT_IMM:
      case A64_SVE_FADDV:
      case A64_SVE_SCVTF:
      case A64_SVE_FCVT:
      case A64_SVE_FMAD:
      case A64_SVE_FCMLA_VECTORS:
      case A64_SVE_FCMLA_INDEXED:
      case A64_SVE_FADDA:
      case A64_SVE_FADD_VEC_PRED:
      case A64_SVE_FADD_VEC_UNPRED:
      case A64_SVE_FADD_IMM:
      case A64_SVE_FMLA_VEC:
      case A64_SVE_LDR_VEC:
      case A64_SVE_LDR_PRED:
      case A64_SVE_LD_VEC_IMM:
      case A64_SVE_LD_BROADCAST:
      case A64_SVE_LD_SCA_SCA_CONSEC:
      case A64_SVE_ST_SCA_SCA_CONSEC:
      case A64_SVE_LD_SCA_IMM_CONSEC:
      case A64_SVE_ST_SCA_IMM_CONSEC:
      case A64_SVE_LDRO_SCA_IMM:
      case A64_SVE_LD_SCA_IMM:
      case A64_SVE_LD_SCA_SCA:
      case A64_SVE_LD_SCA_IMM_REG:
      case A64_SVE_LD_SCA_SCA_REG:
      case A64_SVE_LD_B_SCA_VEC:
      case A64_SVE_LD_D_SCA_VEC:
      case A64_SVE_LD1W_SCA_VEC:
      case A64_SVE_LD1B_SCA_VEC:
      case A64_SVE_LD1B_SCA_SCA:
      case A64_SVE_LD1B_SCA_IMM:
      case A64_SVE_LD1B_VEC_IMM:
      case A64_SVE_ST1H_SCA_VEC:
      case A64_SVE_ST1D_SCA_SCA_REG:
      case A64_SVE_ST1B_SCA_SCA_REG:
      case A64_SVE_ST1B_VEC_IMM:
      case A64_SVE_ST1B_SCA_IMM:
      case A64_SVE_ST1H_SCA_SCA_REG:
      case A64_SVE_STR_PRED:
      case A64_SVE_ST1B_SCA_VEC:
      case A64_SVE_ST_VEC_IMM:
      case A64_SVE_ST_SCA_IMM_REG:
      case A64_SVE_ST_SCA_IMM:
      case A64_SVE_ST_SCA_SCA:
      case A64_SVE_STR_VEC:
        a64_copy();
        break;
